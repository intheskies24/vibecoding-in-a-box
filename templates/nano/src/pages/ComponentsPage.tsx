...
function CodeBlock({ code }: { code: string }) {
  return (
    <pre className="mt-4 bg-slate-950 text-slate-300 px-4 py-3 rounded-lg text-xs font-mono overflow-x-auto leading-relaxed border-t border-gray-100">
      <code>{code}</code>
    </pre>
  );
}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-8 py-8 max-w-3xl space-y-6">
        ...
        <Section title="Typography" description="Heading scale and body text styles">
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-700 leading-relaxed max-w-lg">
              Body text — used for paragraphs and descriptions. Comfortable line height for readability.
            </p>
            <p className="text-sm text-gray-400">
              Muted text — used for secondary information, captions, and helper text.
            </p>
        ...
        {/* Buttons */}
        <Section title="Buttons" description="All variants — drop-in with shadcn Button component">
          <div className="flex flex-wrap gap-2">
            <button className="inline-flex items-center justify-center rounded-md bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 transition-colors">
              Default
            </button>
            <button className="inline-flex items-center justify-center rounded-md bg-slate-100 px-4 py-2 text-sm font-medium text-slate-900 hover:bg-slate-200 transition-colors">
              Secondary
            </button>
            <button className="inline-flex items-center justify-center rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
              Outline
            </button>
            <button className="inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-colors">
              Ghost
            </button>
            <button className="inline-flex items-center justify-center rounded-md bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 transition-colors">
              Destructive
            </button>
            <button disabled className="inline-flex items-center justify-center rounded-md bg-slate-900 px-4 py-2 text-sm font-medium text-white opacity-50 cursor-not-allowed">
              Disabled
            </button>
          </div>
          <CodeBlock code={`<button className="inline-flex items-center justify-center rounded-md bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 transition-colors">
  Default
</button>`} />
        </Section>
        ...
        <Section title="Card" description="Content container with header, body, and footer">
          <div className="rounded-xl border border-gray-200 overflow-hidden max-w-sm">
            ...
            <div className="px-5 py-4">
              <p className="text-gray-600 text-sm">Card content goes here. Add any components or text inside the card body.</p>
            </div>
          ...
          <div className="space-y-4 max-w-sm">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="flex h-9 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-shadow"
              />
            </div>
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                rows={3}
                className="flex w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none transition-shadow"
              />
            </div>
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-gray-700">Select</label>
              <select className="flex h-9 w-full rounded-md border border-gray-300 bg-white px-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
            ...
            <label className="flex items-center gap-2.5 cursor-pointer group">
              ...
              <span className="text-sm text-gray-700 group-hover:text-gray-900">Checkbox label</span>
            </label>
          </div>
        </Section>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mt-0.5">This is an informational message with helpful context.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 bg-emerald-50 border border-emerald-200 rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-emerald-700 mt-0.5">Your action was completed successfully.</p>
              </div>
            </div>
            <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 mt-0.5">Something needs your attention before proceeding.</p>
              </div>
            </div>
