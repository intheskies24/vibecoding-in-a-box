        ...
        <form action={action} className="space-y-3">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={inputClass(supabaseUrl)}
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide">
    ...
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
      ...
      <div className="px-6 py-5 space-y-4">
        ...
        <div className="relative">
          ...
          <button
            onClick={handleCopy}
            className="absolute top-3 right-3 flex items-center gap-1.5 px-2.5 py-1.5 rounded-md bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-medium transition-colors"
          >
